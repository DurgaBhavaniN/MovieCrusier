...
namespace MovieCrusier.Helper
{
	...
	{
		string connectionString= "Data Source = DESKTOP-0LBTHNR\\SQLEXPRESS; User ID =sa;password=pass@word1;Initial Catalog = MovieCrusier; Integrated Security = True; Trusted_Connection=True;";
